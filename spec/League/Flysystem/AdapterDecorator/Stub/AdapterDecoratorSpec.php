...
class AdapterDecoratorSpec extends ObjectBehavior
{
    ...
    public function it_should_decorate_write_calls()
    {
        $config = new Config();
    ...
    public function it_should_decorate_update_calls()
    {
        $config = new Config();
    ...
    public function it_should_decorate_createDir_calls()
    {
        $config = new Config();
    ...
    public function it_should_decorate_updateStream_calls()
    {
        $config = new Config();
        $stream = tmpfile();
